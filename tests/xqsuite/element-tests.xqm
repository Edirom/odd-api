...
declare
    ...
    %test:args('mei', '5.1', 'clef')        %test:assertEquals("odd-special-content-model-element-empty")
    %test:args('mei', '4.0.1', 'clef')      %test:assertEquals("")
    %test:args('tei', '4.8.0', 'content')   %test:assertEquals("alternate anyElement classRef dataRef elementRef empty macroRef odd-special-content-model-element-anyElement sequence textNode valList")
